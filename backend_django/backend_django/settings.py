...
SECRET_KEY = 'django-insecure-3zz+0(18xb_q%abme1xib0hi93-qhgs%amtnz*k-kzrq(h2tuh'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'probando'),
        'USER': os.environ.get('POSTGRES_USER', 'postgres'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'probando'),
